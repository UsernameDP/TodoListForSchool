...
list.forEach(function (inner_list){
    ...
    inner_list.forEach(function (stuff){
        ...
        if (stuff.year == null || stuff.month == null || stuff.day == null){
            ...
            date = new Date(stuff.year, stuff.month, stuff.day);
            week_day = find_weekday(date.getDay());
        }
        Object.assign(stuff, {date: date});
        Object.assign(stuff, {weekDay: week_day});
...
list.forEach(function (list){
    ...
    list.forEach(function (object){
        ...
        const reDate = [object.weekDay, object.inputdate];
